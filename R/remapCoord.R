remapCoord <-
  function(features,
    ...
    # get 5UTR, CDS and 3UTR information from txdb
    ...
    get_promoter_function <-
      function(width_promoter, num_bin_promoter, fiveUTR_align, fiveUTR_tx0, methyl){
        ...
        promoter_pstv_rgs         <- flank(promoter_pstv_start, width_tail, start = TRUE)
        promoter_ngtv_rgs         <- flank(promoter_ngtv_start, width_tail, start = TRUE)
